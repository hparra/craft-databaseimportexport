...
// Changed default config path - HGPA
$configPath = dirname(__FILE__).'/../../app/etc/config/console.php';
...
// Changed path
require_once dirname(__FILE__).'/../../app/framework/yii.php';
require_once CRAFT_APP_PATH.'Craft.php';
require_once CRAFT_APP_PATH.'Info.php';

// Changed path
require_once(dirname(__FILE__).'/../../app/etc/console/ConsoleApp.php');
...
// Changed path
$app->commandRunner->addCommands(dirname(__FILE__).'/consolecommands/');
